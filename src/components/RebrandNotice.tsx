...
export default function RebrandNotice() {
	...
	return (
		<>
			<div className="bg-[color:var(--color-biohack-green)] p-2 text-center text-white">
				<Link href="/bio-hack">{t("eventBanner")}</Link>
			</div>
			<div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary to-secondary px-8 py-12 text-center text-primary-foreground">
